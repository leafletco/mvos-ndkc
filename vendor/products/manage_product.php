...
<div class="container-fluid">
    ...
    <input type="file" id="logo" name="img" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this))" accept="image/png, image/jpg, image/jpeg"  <?= !isset($id) ? 'required' : '' ?>>
