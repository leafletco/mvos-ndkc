...
<div class="container-fluid">
	<form action="" id="category-form">
		...
		<div class="form-group">
			...
			<option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Admin Approved</option>
			<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Pending Admin Approval</option>
			</select>
		</div>
