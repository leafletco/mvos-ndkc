		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input name="name" id="name" type="text"class="form-control form-control-sm form-control-border" value="<?php echo isset($name) ? $name : ''; ?>" required disabled>
				</div>
				<div class="form-group">
						<label for="category_id" class="control-label">Category</label>
						<select type="text" id="category_id" name="category_id" class="form-control form-control-sm form-control-border select2" required disabled>
				...
				<div class="form-group">
					...
					<textarea name="description" id="description" rows="4"class="form-control form-control-sm rounded-0 summernote" required disabled><?php echo isset($description) ? html_entity_decode($description) : ''; ?></textarea>
				</div>
			</div>
			<div class="col-md-6">
    <div class="form-group">
        <label for="price" class="control-label">Cost</label>
        <input name="price" id="price" type="number" step="any" class="form-control form-control-sm form-control-border" value="<?= isset($price) ? $price : ''; ?>" required disabled>
    </div>
    <!-- Add input field for stock quantity -->
    <div class="form-group">
        <label for="stock_available" class="control-label">Available Stock</label>
        <input name="stock_available" id="stock_available" type="number" step="1" class="form-control form-control-sm form-control-border" value="<?= isset($stock_available) ? $stock_available : ''; ?>" required disabled>
    </div>

				<div class="form-group">
					<label for="logo" class="control-label">Product Image</label>
					<input type="file" id="logo" name="img" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this))" accept="image/png, image/jpeg, image/jpg" disabled <?= !isset($id) ? 'required' : '' ?>>
				</div>
